...
PRIVATE_CONFIG=data/tm.ipc nohup geth --datadir data $ARGS --permissioned --raftport 50401 --rpcport 22000 --port 21000 --unlock 0 --password passwords.txt 2>>data/logs/geth.log &
set +v
